...
public static class E15ProjectSetup
{
    ...
    private static void ValidateReleaseArtifacts(ICollection<string> errors)
    {
        var requiredFiles = new Dictionary<string, string[]>
        {
            ...
            ["tools/android/build-signed-store-aab.ps1"] = new[] { "BuildSignedAab", "BuildSignedApk", "Artifact", "provenance.json", "gitHeadBefore", "projectSettingsRestored" },
            ["tools/android/build-e15-baseline-apk.ps1"] = new[] { "28f7e88", "worktree", "bundletool", "universal.apk", "BaselineUniversalApk", "orchestratorGitHeadBefore", "sourceProjectSettingsRestored" },
            ["tools/android/prepare-e15-release-artifacts.ps1"] = new[] { "PreflightOnly", "upstream-sync", "build-e15-baseline-apk.ps1", "build-signed-store-aab.ps1", "run-e15-release-gate.ps1", "ArtifactOnly", "artifact_set_prepared", "e15-artifact-set.json" },
            ...
            ["tools/android/run-e15-block-gate.ps1"] = new[] { "PreflightOnly", "PLAYTEST-001", "DEVICE-QA-001", "STORE-ACCOUNT-001", "ConfirmStorePackageReset", "test-android-qa-provenance.ps1", "test-e15-artifact-provenance.ps1", "test-e15-baseline-provenance.ps1", "test-e15-block-manifest.ps1", "test-e15-performance-evidence.ps1", "Test-E15TechnicalGateManifest", "technical_gate_passed" },
            ...
            ["tools/android/e15-block-manifest.ps1"] = new[] { "Test-E15TechnicalGateManifest", "technical_gate_passed", "artifact:hashes", "logSha256", "RequireEvidenceFiles" },
