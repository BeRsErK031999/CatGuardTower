...
public static class E15ProjectSetup
{
    ...
    private static void ValidateReleaseArtifacts(ICollection<string> errors)
    {
        ...
        {
            [WorkflowPath] = new[] { "clean install", "upgrade install", "offline", "physical device", "signing credential rotation", "dual-password", "run-e15-release-gate.ps1", "run-e15-default-economy-qa.ps1" },
            ["docs/09_GOOGLE_PLAY_RELEASE.md"] = new[] { "dual-password DPAPI bundle", "CATGUARD_SIGNING_CREDENTIAL_PATH", "CATGUARD_SIGNING_ROTATION_RECORD_PATH", "process-level password values are forbidden" },
            ...
            ["tools/android/build-signed-store-aab.ps1"] = new[] { "BuildSignedAab", "BuildSignedApk", "Artifact", "provenance.json", "gitHeadBefore", "projectSettingsRestored", "JavaTempRoot", "SigningCredentialRotationRecordPath", "Get-E15SigningCredentialBundle", "hash-bound DPAPI credential bundle", "Protect-E15BuildLogFile" },
            ["tools/android/build-e15-baseline-apk.ps1"] = new[] { "28f7e88", "worktree", "bundletool", "universal.apk", "BaselineUniversalApk", "orchestratorGitHeadBefore", "sourceProjectSettingsRestored", "JavaTempRoot", "SigningCredentialRotationRecordPath", "Get-E15SigningCredentialBundle", "hash-bound DPAPI credential bundle", "Copy-E15BaselineBuildDiagnostics", "Preserved diagnostics" },
            ["tools/android/prepare-e15-release-artifacts.ps1"] = new[] { "PreflightOnly", "upstream-sync", "java-temp-root", "signing-credential-rotation", "signing-credential-access", "signing-password-source", "SigningCredentialPath", "SigningCredentialRotationRecordPath", "e15-signing-credential-rotation.ps1", "build-e15-baseline-apk.ps1", "e15-build-log-redaction.ps1", "e15-baseline-build-diagnostics.ps1", "e15-java-temp.ps1", "build-signed-store-aab.ps1", "run-e15-release-gate.ps1", "ArtifactOnly", "Test-E15ArtifactSetManifest", "signingCredentialRotation", "credentialVerification", "keytoolSha256", "artifact_set_prepared", "artifact_set_contract_failed", "e15-artifact-set.json" },
            ...
            ["tools/android/e15-artifact-set-manifest.ps1"] = new[] { "Test-E15ArtifactSetManifest", "artifact_set_prepared", "artifact-only-preflight", "signingCredentialRotation", "credentialVerification", "keytoolSha256", "ExpectedRepositoryRoot", "ExpectedArtifactPaths", "RequireEvidenceFiles" },
            ...
            ["tools/android/e15-signing-credential-rotation.ps1"] = new[] { "Get-E15SigningCredentialBundle", "New-E15SigningCredentialBundle", "Test-E15SigningCredentialAccess", "Test-E15SigningCredentialRotationRecord", "New-E15SigningCredentialRotationRecord", "signing_credential_ready", "incidentCutoffUtc", "retiredKeystoreSha256", "retiredCredentialFileSha256", "keytool-env-list", "credential_rotated" },
            ["tools/android/new-e15-signing-credential-bundle.ps1"] = new[] { "New-E15SigningCredentialBundle", "Rotated Android keystore password", "Rotated Android key password", "Bundle SHA256" },
            ["tools/android/rotate-e15-signing-credentials.ps1"] = new[] { "PreflightOnly", "ConfirmRotation", "GeneratePasswords", "RecoveryFilePath", "current-user-only ACL", "Read-ConfirmedPassword", "keypasswd", "storepasswd", "New-RandomProbePassword", "New-E15SigningCredentialBundle", "New-E15SigningCredentialRotationRecord", "original JKS was restored" },
            ["tools/android/register-e15-signing-credential-rotation.ps1"] = new[] { "New-E15SigningCredentialRotationRecord", "CATGUARD_SIGNING_CREDENTIAL_PATH", "CATGUARD_SIGNING_ROTATION_RECORD_PATH", "CATGUARD_KEYTOOL_PATH", "Record SHA256" },
            ...
            ["tools/android/test-e15-artifact-set-manifest.ps1"] = new[] { "mismatched-input", "wrong-head", "missing-artifact", "wrong-hash", "retired-signing", "wrong-signing-verifier", "wrong-preflight", "tampered-log", "contract tests passed" },
            ...
            ["tools/android/test-e15-signing-credential-bundle.ps1"] = new[] { "valid", "wrong-alias", "existing-output", "inside-repo", "empty-password", "legacy-pscredential", "malformed-schema", "tests passed" },
            ["tools/android/test-e15-signing-credential-access.ps1"] = new[] { "valid", "wrong-password", "wrong-alias", "wrong-certificate", "legacy-pscredential", "missing-key-password", "stale-bundle", "missing-keytool", "wrong-keytool-binding", "tests passed" },
            ["tools/android/test-e15-signing-credential-rotation.ps1"] = new[] { "valid", "stale-timestamp", "wrong-keystore-hash", "wrong-credential-hash", "record-inside-repo", "retired-keystore", "retired-credential", "contract tests passed" },
