...
| `STORE-ACCOUNT-001` | not started | rotated upload-key passwords and refreshed DPAPI credential, owner/legal/contact, public privacy URL, Play Console forms, listing approval, and upload-key recovery record |
