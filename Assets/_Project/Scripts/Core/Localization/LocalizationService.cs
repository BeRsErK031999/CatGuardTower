...
namespace CatGuard.Core.Localization
{
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, string> EnglishText = new()
        {
            ...
            ["quest.progressReward"] = "{0}/{1}  |  +{2} Fish",
            ...
            ["hub.guardianHint"] = "These three map-scale abilities are equipped for every battle. Loadout editing arrives with guardian growth.",
        ...
        private static readonly Dictionary<string, string> RussianText = new()
        {
            ...
            ["quest.progressReward"] = "{0}/{1}  |  +{2} рыбок",
            ...
            ["hub.guardianHint"] = "Эти три масштабные способности доступны в каждом бою. Настройка набора появится вместе с развитием Хранителя.",
