...
public static class E15ProjectSetup
{
    ...
    private static void ValidateReleaseArtifacts(ICollection<string> errors)
    {
        var requiredFiles = new Dictionary<string, string[]>
        {
            ...
            ["tools/android/rotate-e15-signing-credentials.ps1"] = new[] { "PreflightOnly", "ConfirmRotation", "Read-ConfirmedPassword", "keypasswd", "storepasswd", "New-RandomProbePassword", "New-E15SigningCredentialBundle", "New-E15SigningCredentialRotationRecord", "original JKS was restored" },
